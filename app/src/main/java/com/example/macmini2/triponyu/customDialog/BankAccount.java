 ...
 */
public class BankAccount extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(this.getActivity()).inflate(R.layout.dialog_bank_account, null, false);
